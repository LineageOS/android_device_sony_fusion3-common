...
# Custom init / uevent
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/init.qcom.bt.sh:system/etc/init.qcom.bt.sh \
...
# ALSA configuration
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/system/etc/snd_soc_msm_2x_Fusion3:system/etc/snd_soc_msm/snd_soc_msm_2x_Fusion3
