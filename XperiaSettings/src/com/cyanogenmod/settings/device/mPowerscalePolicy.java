...
public class mPowerscalePolicy extends ListPreference implements OnPreferenceChangeListener {
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE_POWERSCALE_POLICY, sharedPrefs.getString(DeviceSettings.KEY_POWERSCALE_POLICY, "trustzone"));
    }

    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Utils.writeValue(FILE_POWERSCALE_POLICY, (String) newValue);
        return true;
    }
