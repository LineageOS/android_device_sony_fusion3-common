...
#define BACKLIGHT_PATH            "/sys/class/leds/lm3533-lcd-bl-1/brightness"
#define SECONDARY_BACKLIGHT_PATH  "/sys/class/leds/lm3533-lcd-bl-2/brightness"
#else
#define BACKLIGHT_PATH            "/sys/class/leds/lm3533-lcd-bl/brightness"
#endif
